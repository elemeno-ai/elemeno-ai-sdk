...
class TestFeatureStore(unittest.TestCase):
    def test_get_training_features_download_files(self):
        ...
        feature_table = FeatureTable(
            ...
            features=[
                feast.Feature(name="feature_1", dtype=feast.ValueType.INT64),
                feast.Feature(name="feature_2", dtype=feast.ValueType.INT64),
            ],
        )
        ...
        # Call the method
        result_df = feature_store.get_training_features(feature_table=feature_table, download_binaries=True)
