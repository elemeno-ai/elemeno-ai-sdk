...
class IngestionSourceBuilder:
    ...
    def build_elastic(
        self, host: Optional[str] = None, username: Optional[str] = None, password: Optional[str] = None
    ) -> ElasticIngestionSource:
    ...
    def build_big_query(
        self, project_id: Optional[str] = None, base_query: Optional[str] = None
    ...
    def build_redshift(
        ...
        return RedshiftIngestionSource(
            cluster_name=cluster_name, user=user, database=database, base_query=base_query, iam_role=iam_role
        )
