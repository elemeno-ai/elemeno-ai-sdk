...
class ModelRegistry:
    ...
    def get_latest_model_torch(self, model_name: str, device: str):
        ...
        model = mlflow.pytorch.load_model(model_uri=f"models:/{model_name}/{stage}", map_location=torch.device(device))
    ...
    def get_latest_model_onnx(self, model_name: str):
        ...
        model = mlflow.onnx.load_model(model_uri=f"models:/{model_name}/{stage}")
